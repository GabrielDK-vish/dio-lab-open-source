...
> [!NOTE]   
> Por exemplo, a URL https://github.com/GabrielDK-vish/dio-lab-open-source é o "**fork**" feito pelo usuário do GitHub "`GabrielDK-vish`" para a contribuição no repositório `dio-lab-open-source`.
